...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsReducer(startState, todolistsActions.addTodolistTC.fulfilled(todolist, 'requestId', todolist.title))
...
test('correct todolist should change its name', () => {
    ...
    const action = todolistsActions.changeTodolistTitleTC.fulfilled(param, 'requestId', param)
