...
test('correct task should be deleted from correct array', () => {
    ...
    const action = tasksActions.removeTaskTC.fulfilled(param, 'requestId', param);
...
test('status of specified task should be changed', () => {
    ...
    const action = tasksActions.updateTaskTC.fulfilled(param, 'requestId', param);
...
test('title of specified task should be changed', () => {
    let param = {taskId: '2', model: {title: 'yogurt'}, todolistId: 'todolistId2'};
    const action = tasksActions.updateTaskTC.fulfilled(param, 'requestId', param);
...
test('new array should be added when new todolist is added', () => {
    ...
    const action = todolistsActions.addTodolistTC.fulfilled(param, 'requestId', param.title);
